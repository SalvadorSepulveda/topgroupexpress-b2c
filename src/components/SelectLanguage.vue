  ...
  <div class="relative ml-[30px] w-[100px] flex items-center dark:text-white cursor-pointer">
    <div class="flex z-10" @click="toggleDropdown">
      <div class="mt-[4px]">
        <TGEFlag
            ...
            class="w-8 h-8 inline-block rounded-full ring-1 ring-white bg-white"
        />
      </div>
    </div>
    ...
    >
      ...
      >
        <TGEFlag
            :name="language.flag"
            class="w-8 h-8 inline-block rounded-full ring-1 ring-white bg-white mt-1.5"
        />
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    filteredLanguages() {
      // Filtrar los idiomas para excluir el idioma seleccionado
