                ...
                <div class="mx-auto w-full max-w-[970px]">
                    ...
                    <div class="mx-auto w-full max-w-[770px] text-center">
                        <h1
                            ...
                            data-wow-delay=".25s"
                        >
                            50+ High rated online banking mobile apps on
                            playstore.
                        </h1>
                        <div
                        ...
                        <div class="text-left">
                            <p
                                class="wow fadeInUp mb-9 text-base text-body"
                                data-wow-delay=".2s"
                            >
                                ...
                                varius. Quam pellentesque nec nam aliquam sem et
                                tortor consequat. Pellentesque adipiscing
                                commodo elit at imperdiet.
                            </p>

                            <p
                                class="wow fadeInUp mb-10 text-base text-body"
                                data-wow-delay=".2s"
                            >
                                Semper auctor neque vitae tempus quam
                                pellentesque nec. Amet dictum sit amet justo
                            ...
                            <h3
                                class="wow fadeInUp mb-6 text-xl font-semibold text-black dark:text-white sm:text-2xl"
                                data-wow-delay=".2s"
                            >
                            ...
                            <ul
                                class="wow fadeInUp mb-9 list-inside list-disc space-y-4"
                                data-wow-delay=".2s"
                            >
